...
<!-- indexer::stop -->
<div class="<?php echo $this->class; ?> mod_iso_orderdetails block"<?php echo $this->cssID; ?><?php if ($this->style): ?> style="<?php echo $this->style; ?>"<?php endif; ?>>
...
<table cellspacing="0" cellpadding="0" summary="Order items">
	<tfoot>
		<tr class="subtotal foot_first">
			<td class="col_first name" colspan="4"><?php echo $this->subTotalLabel; ?></td>
			<td class="price">&nbsp;</td>
...
<?php if (is_array($this->surcharges)): foreach( $this->surcharges as $surcharge ): ?>
		<tr>
			<td class="col_first name" colspan="4"><?php echo $surcharge['label']; ?></td>
...
<?php endforeach; endif; ?>
		<tr class="grandtotal foot_last">
			<td class="col_first name" colspan="4"><?php echo $this->grandTotalLabel; ?></td>
...
<?php foreach( $this->items as $item ): ?>
		<tr>
			...
			<td class="col_1 token"><?php echo $item['token']; ?></td>
			<td class="col_2 name"><?php if (strlen($item['href'])): ?><a href="<?php echo $item['href']; ?>"><?php endif; echo $item['name']; if (strlen($item['href'])): ?></a><?php endif; ?>
			...
			<td class="col_3 quantity"><?php echo $item['quantity']; ?></td>
			<td class="col_4 price"><?php echo $item['price']; ?></td>
			<td class="col_5 price total"><?php echo $item['total']; ?></td>
	    	<td class="col_6 col_last tax"><?php echo $item['tax_id']; ?></td>
		</tr>
<?php endforeach; ?>
	</tbody>
</table>
